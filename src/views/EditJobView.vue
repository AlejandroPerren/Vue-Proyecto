...
const handleSubmit = async () => {
  ...
  try {
    ...
    toast.error('El trabajo no fue actualizado');
  }
};
    ...
    <div class="container m-auto max-w-2xl py-24">
      ...
      >
        <form @submit.prevent="handleSubmit">
          <h2 class="text-3xl text-center font-semibold mb-6">Editar Trabajo</h2>
          ...
          <div class="mb-4">
            ...
            <input
              ...
              placeholder="ej. Hermoso Apartamento en Miami"
              required
            />
          </div>
          <div class="mb-4">
            ...
            <textarea
              ...
              class="border rounded w-full py-2 px-3"
              rows="4"
              placeholder="Agrega cualquier deber, expectativas, requisitos, etc."
            ></textarea>
          </div>
          ...
          <div class="mb-4">
            ...
            >
              ...
              <option value="Más de $200K">Más de $200K</option>
            </select>
          </div>
          ...
          <h3 class="text-2xl mb-5">Información de la Empresa</h3>
          ...
          <div class="mb-4">
            ...
            <input
              ...
              name="contact_email"
              class="border rounded w-full py-2 px-3"
              placeholder="Correo electrónico para solicitantes"
              required
            />
          </div>
          <div class="mb-4">
            ...
            <input
              ...
              name="contact_phone"
              class="border rounded w-full py-2 px-3"
              placeholder="Teléfono opcional para solicitantes"
            />
          </div>
